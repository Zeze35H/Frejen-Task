...
type Props = {
    user: { id: number; name: string; id_department: string };
};
...
const Profile: React.FC<Props> = ({user}:Props) => {
    ...
    const [department, setDepartment] = useState(user.id_department || '');
    ...
    const handleUpdate = async (e: React.FormEvent) => {
        ...
        try {
            await updateUser(user.id, { name, password, department });
